...
replace('/var/www/surveillance_config.txt', c.runMode, sys.argv[1])
replace('/var/www/surveillance_config.txt', c.active_time_start_h, sys.argv[2])
replace('/var/www/surveillance_config.txt', c.active_time_start_m, sys.argv[3])
replace('/var/www/surveillance_config.txt', c.active_time_stop_h, sys.argv[4])
replace('/var/www/surveillance_config.txt', c.active_time_stop_m, sys.argv[5])
